...
export default function DatabricksSchemaBrowser({
  ...
  const handleDatabaseFilterChange = useDebouncedCallback(
    setDatabaseFilterString, 500
  );
  const cancelHandleDatabaseFilterChange = handleDatabaseFilterChange.cancel
