...
import SelectItemsDialog from "@/components/settings/SelectItemsDialog";
import { DataSourcePreviewCard } from "@/components/general/PreviewCard";

import GroupName from "@/components/settings-groups/GroupName";
import ListItemAddon from "@/components/settings-groups/ListItemAddon";
import Sidebar from "@/components/settings-groups/DetailsPageSidebar";
...
routes.register(
  ...
  routeWithUserSession({
    path: "/groups/:groupId/data-sources",
