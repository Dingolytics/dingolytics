...
import CreateGroupDialog from "@/components/settings-groups/CreateGroupDialog";
import DeleteGroupButton from "@/components/settings-groups/DeleteGroupButton";
    ...
    Columns.custom(
      (text, group) => (
        <Button.Group>
          ...
          {currentUser.isAdmin && <Link.Button href={`groups/${group.id}/data-sources`}>Data Sources</Link.Button>}
        </Button.Group>
      ),
      {
        width: "1%",
