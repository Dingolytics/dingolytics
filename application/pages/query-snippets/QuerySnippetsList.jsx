...
import QuerySnippetDialog from "@/components/query-editor/QuerySnippetDialog";
...
class QuerySnippetsList extends React.Component {
    ...
    if (isNewOrEditPage) {
      if (querySnippetId === "new") {
        if (policy.isCreateQuerySnippetEnabled()) {
          ...
          navigateTo("query-snippets", true);
        }
      } else {
  ...
  showSnippetDialog = (querySnippet = null) => {
    ...
    navigateTo("query-snippets/" + get(querySnippet, "id", "new"), true);
    const goToSnippetsList = () => navigateTo("query-snippets", true);
...
routes.register(
  ...
  routeWithUserSession({
    ...
    title: "Query Snippets",
    render: pageProps =>
      <QuerySnippetsListPage {...pageProps}
        currentPage="query-snippets"
      />,
  })
);
routes.register(
  ...
  routeWithUserSession({
    path: "/query-snippets/:querySnippetId",
    title: "Query Snippets",
    render: pageProps =>
      <QuerySnippetsListPage {...pageProps}
        currentPage="query-snippets" isNewOrEditPage
      />,
  })
);
